        ...
        <div class="uk-card uk-card-hover uk-card-default uk-card-small uk-animation-fade l3card">
            <div class="uk-card-header uk-grid-small" uk-grid>
                <div class="uk-width-expand@m">
                    <h3 class="uk-card-title sikd-blue-text uk-float-left uk-margin-remove uk-text-uppercase">Tambah Mapping Akun</h3>
                </div>
            ...
            <div class="uk-card-body">
                @if($errors->any())
                    <h4>{{ $errors->first() }}</h4>
                @endif
                <form id="edit_account_form" method="POST" action="{!! url('account-mapping/create') !!}">
                    {!! csrf_field() !!}
                    <div class="uk-margin">
                        <label class="uk-form-label" for="primary_account">Kode akun utama</label>
                        <div class="uk-form-controls">
                            <input class="uk-input" id="primary_account" name="primary_account" type="text" >
                        </div>
                    </div>
                    <div class="uk-margin">
                        <label class="uk-form-label" for="group_account">Kode akun kelompok</label>
                        <div class="uk-form-controls">
                            <input class="uk-input" id="group_account" name="group_account" type="text" >
                        </div>
                    </div>
                    <div class="uk-margin">
                        <label class="uk-form-label" for="account_type">Kode jenis akun</label>
                        <div class="uk-form-controls">
                            <input class="uk-input" id="account_type" name="account_type" type="text" >
                        </div>
                    </div>
                    <div class="uk-margin">
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <input class="uk-input" id="label" name="label" type="text" >
                        </div>
                    </div>
